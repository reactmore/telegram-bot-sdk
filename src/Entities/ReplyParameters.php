 ...
 * @method list<MessageEntity> getQuoteEntities()                                                                                                                                                                           Optional. A JSON-serialized list of special entities that appear in the quote. It can be specified instead of quote_parse_mode.
